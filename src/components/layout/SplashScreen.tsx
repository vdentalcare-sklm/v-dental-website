    ...
    <AnimatePresence>
      {showSplash && (
        <motion.div
          ...
          className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-[#F2FBF7]"
        >
          {/* Ambient Glow */}
          <motion.div
            ...
            className="absolute w-[300px] h-[300px] md:w-[500px] md:h-[500px] bg-[#005C96]/20 rounded-full blur-[80px]"
          />
          ...
          <motion.p
            ...
            className="mt-6 text-[#5AA647] font-light tracking-widest text-xs md:text-sm z-10 uppercase text-center max-w-xs md:max-w-none"
          >
