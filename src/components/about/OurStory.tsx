...
export default function OurStory() {
  return (
    <section className="w-full py-24 md:py-32 bg-[#FAFAF7] overflow-hidden text-text-primary">
      <div className="container mx-auto px-6 lg:px-12 max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            <div className="absolute inset-0 bg-[#005C96]/10 mix-blend-overlay z-10" />
            ...
            />
            {/* Decorative Overlay */}
            <div className="absolute inset-0 border border-[#E5E7EB] rounded-3xl z-20 pointer-events-none" />
          </motion.div>
          ...
          <div className="flex flex-col justify-center">
            ...
            >
              <h3 className="text-[#005C96] font-medium tracking-[0.2em] text-sm uppercase mb-4 flex items-center gap-2">
                <span className="w-8 h-[1px] bg-brand-400"></span>
                Our Story
              </h3>
              
              <h2 className="text-3xl md:text-5xl font-light leading-tight mb-8">
                Built Around One Mission — <span className="font-medium text-[#083D5B]">Better Smiles, Better Lives</span>
              </h2>
            </motion.div>
            ...
            <motion.div
              ...
              className="space-y-6 text-text-secondary text-lg font-light leading-relaxed"
            >
              <p>
